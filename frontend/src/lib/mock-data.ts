...
export const mockProgress: ResourceProgress[] = [
  ...
  { resourceId: 'res-006', userId: 'user-001', status: 'not_started', completed: false, progressPercent: 0 },
  { resourceId: 'res-007', userId: 'user-001', status: 'not_started', completed: false, progressPercent: 0 },
  { resourceId: 'res-008', userId: 'user-001', status: 'not_started', completed: false, progressPercent: 0 },
  { resourceId: 'res-009', userId: 'user-001', status: 'not_started', completed: false, progressPercent: 0 },
];
