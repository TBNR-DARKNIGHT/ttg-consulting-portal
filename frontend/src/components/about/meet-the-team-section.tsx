...
function TeamPhoto({ member }: { member: (typeof team)[number] }) {
  ...
  if (failed) {
    return (
      <div
        className="grid size-[120px] place-items-center rounded-full bg-[#e8e8fa] text-sm font-semibold text-brand-indigo"
        aria-hidden
      >
        {member.initials}
      </div>
      ...
      <section className="relative overflow-hidden bg-brand-dark">
        ...
        <div className="relative mx-auto max-w-[960px] px-5 py-16 md:px-8 md:py-20">
          ...
          <h1 className="max-w-[720px] font-serif text-4xl font-bold leading-[1.12] tracking-[-0.02em] text-white md:text-[52px]">
            ...
            <br />
            <em className="font-normal text-[#a8a8f0]">Missing From the Inside.</em>
          </h1>
      ...
      <section className="border-b border-brand-dark/15 bg-brand-grey">
        <div className="mx-auto max-w-[960px] px-5 py-16 md:px-8 md:py-20">
          ...
          <h2 className="text-3xl font-bold leading-[1.2] text-brand-dark md:text-[40px]">
            ...
            <br />
            <em className="font-normal text-brand-indigo">the gap from the inside.</em>
          </h2>
          <div className="mt-12 grid items-start gap-10 md:grid-cols-2 md:gap-16">
            <div className="space-y-5 text-[15px] leading-[1.75] text-brand-dark/70">
              <p>
                ...
                were not smart enough, but because they had not yet found their personal brand or
                the confidence to speak authentically.
              </p>
              <p>
                We created Beyond Grades because these insider skills should not be a secret.
                Whether your child is preparing for DSA, university, or a competitive scholarship,
                we help them find their voice and position themselves for success.
              </p>
              <p>
                From free resources to specialised coaching, we make high-level mentorship
                accessible to every student who is ready to be heard.
              </p>
            </div>
            <aside className="rounded-xl bg-brand-dark px-8 py-10 md:px-10 md:py-12">
              <blockquote className="font-serif text-[22px] italic leading-[1.5] text-white/90">
                “Your grades get you into the room. Your voice gets you the seat.”
              </blockquote>
              <cite className="mt-6 block text-[13px] not-italic text-white/40">
      ...
      >
        <div className="mx-auto max-w-[960px] px-5 py-16 md:px-8 md:py-20">
          ...
          >
            Four founders.
            <br />
            <em className="font-normal text-brand-indigo">One shared conviction.</em>
          </h2>
          <p className="mb-12 mt-5 max-w-[680px] leading-[1.7] text-brand-dark/70">
            Between us, we hold degrees from Oxford, Cambridge, UCLA, and SMU. We have navigated
            DSA, secured PSC and SAFOS Overseas Scholarships, and gained early careers experience at
            UBS and GIC.
          </p>
          <div className="grid overflow-hidden rounded-xl border border-brand-dark/15 md:grid-cols-2">
            {team.map((member) => (
              <article
                key={member.name}
                className="flex flex-col border-b border-brand-dark/15 bg-white px-8 py-10 odd:md:border-r [&:nth-child(3)]:md:border-b-0 [&:nth-child(4)]:border-b-0"
              >
                <TeamPhoto member={member} />
                <p className="mt-5 text-[10px] font-semibold uppercase tracking-[0.1em] text-brand-indigo">
                  Co-founder
                </p>
                ...
                <div className="mt-4 flex flex-wrap gap-1.5">
                  {member.tags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full bg-[#e8e8fa] px-2.5 py-1 text-[11px] text-brand-indigo"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <a
                  ...
                  className="mt-4 inline-flex items-center gap-1.5 text-xs font-semibold text-brand-indigo hover:opacity-75"
                >
      ...
      <section className="border-b border-brand-dark/15 bg-brand-grey">
        <div className="mx-auto max-w-[960px] px-5 py-16 md:px-8 md:py-20">
          ...
          <h2 className="text-3xl font-bold leading-[1.2] text-brand-dark md:text-[40px]">
            Confidence starts
            <br />
            <em className="font-normal text-brand-indigo">before secondary school.</em>
          </h2>
          <div className="mt-12 grid items-center gap-10 rounded-xl border border-brand-dark/15 bg-white px-8 py-10 md:grid-cols-2 md:px-10">
            <div>
              ...
              <p className="mt-3 text-[15px] leading-[1.7] text-brand-dark/70">
                The same team brings confident communication to Primary 1 to 6 children through a
                joyful year-long programme delivered in Singapore and Shanghai.
              </p>
              <Link
                to="/young-explorers"
            ...
            <div className="flex flex-wrap gap-8">
              {[
                ...
                <div key={label}>
                  <p className="font-serif text-[28px] font-bold text-brand-dark">{value}</p>
      ...
      <section className="bg-brand-dark text-center">
        <div className="mx-auto max-w-[560px] px-5 py-16 md:px-8 md:py-20">
          ...
          <h2 className="text-3xl font-bold leading-[1.2] text-white md:text-[40px]">
            ...
            <br />
            <em className="font-normal text-[#a8a8f0]">One place to start.</em>
          </h2>
          <p className="mt-4 leading-[1.7] text-white/60">
            Explore our offerings at your own pace, in a cohort, or one-on-one with our team.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link
              to="/portal"
              className="rounded-[7px] bg-brand-indigo px-7 py-3.5 text-sm font-semibold text-white"
            >
              Explore the Portal - Free to Join
            </Link>
            <Link
              to="/consult"
              className="rounded-[7px] border border-white/25 px-7 py-3.5 text-sm text-white/75"
            >
