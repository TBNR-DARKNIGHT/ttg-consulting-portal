...
export function ContentDashboardShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-white text-foreground">
      <ContentDashboardSidebar />
      <div className="flex h-svh min-w-0 flex-1 flex-col overflow-auto bg-white">
        <div className="sticky top-0 z-40 shrink-0">
          <div className="flex h-14 items-center gap-3 border-b border-border bg-white/90 px-4 backdrop-blur-md md:hidden">
          ...
          <div className="border-b border-brand-indigo/30 bg-brand-indigo px-4 py-2 text-white shadow-sm">
            <div className="mx-auto flex max-w-6xl flex-col items-start gap-2 text-sm sm:flex-row sm:items-center sm:justify-center">
              ...
              <Button
                asChild
                size="sm"
                className="h-8 shrink-0 gap-1.5 rounded-md bg-white px-3 text-xs font-semibold text-brand-indigo hover:bg-brand-cream"
              >
